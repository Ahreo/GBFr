...
{
    SDL_SetAppMetadata("Reo's GameBoy Emulator", "0.1", "com.example.renderer-clear");
    ...
    if (!SDL_CreateWindowAndRenderer("Reo's GameBoy Emulator", 640, 480, 0, &window, &renderer)) {
